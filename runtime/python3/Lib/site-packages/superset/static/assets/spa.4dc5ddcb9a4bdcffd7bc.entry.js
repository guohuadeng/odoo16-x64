...
`;function k({toast:e,onCloseToast:t}){const a=(0,n.useRef)(),[i,r]=(0,n.useState)(!1),o=()=>{r(!0)},d=(0,n.useCallback)((()=>{a.current&&clearTimeout(a.current),r((()=>(setTimeout((()=>{t(e.id)}),150),!1)))}),[t,e.id]);(0,n.useEffect)((()=>(setTimeout(o),e.duration>0&&(a.current=setTimeout(d,e.duration)),()=>{a.current&&clearTimeout(a.current)})),[d,e.duration]);let l="toast--success",s=(0,v.tZ)(w.Z.CircleCheckSolid,{css:e=>S(e)});return e.toastType===x.p.WARNING?(s=(0,v.tZ)(w.Z.WarningSolid,{css:S}),l="toast--warning"):e.toastType===x.p.DANGER?(s=(0,v.tZ)(w.Z.ErrorSolid,{css:S}),l="toast--danger"):e.toastType===x.p.INFO&&(s=(0,v.tZ)(w.Z.InfoSolid,{css:S}),l="toast--info"),(0,v.tZ)(C,{className:y()("alert","toast",i&&"toast--visible",l),role:"alert"},s,(0,v.tZ)(_.ZP,{content:e.text,noHtml:!e.allowHtml}),(0,v.tZ)("i",{className:"fa fa-close pull-right pointer",role:"button",tabIndex:0,onClick:d,"aria-label":"Close"}))}const E=g.iK.div`
  max-width: 600px;
  position: fixed;
