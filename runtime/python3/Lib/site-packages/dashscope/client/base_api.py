...
class BaseAsyncApi(AsyncTaskGetMixin):
    ...
    @classmethod
    def call(cls, *args, api_key: None, **kwargs) -> DashScopeAPIResponse:
        """Call service and get result.
        """
        task_response = cls.async_call(*args, api_key=api_key, **kwargs)
        response = cls.wait(task_response, api_key=api_key)
        return response
